...
public partial class Processor
{
    ...
    void Inner()
    {
        ...
        if (Weavers.Count == 0)
        {
            Logger.LogError("You don't seem to have configured any weavers. Try adding a Fody nuget package to your project. Have a look here for the list of available packages.");
            return;
        }
        lock (locker)
        {
